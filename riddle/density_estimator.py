...
class DensityEstimator:
    ...
    def __init__(
        self, filename, eval_mode=False, load_path=None, device=torch.device("cpu"), verbose=False, **kwargs
    ):
        self.bound = False
...
class DE_MAF(DensityEstimator):
    ...
    def build_block(self, i, modules, params):
        ...
        if params["batch_norm"]:
            modules += [fnn.BatchNormFlow(params["num_inputs"], momentum=params["batch_norm_momentum"])]
